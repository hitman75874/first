...
<template>
  <div class="w-full flex flex-col gap-3 p-5 dark:accent-light">
    <section
      v-for="(item, index) in list"
      :key="item.id"
      class="hot cursor-pointer bg-#dffe md:bg-amber-2 sm:bg-blue-3"
    ...
    >
      ...
      <img :src="item.children[0].thumbnail" aspect-ratio="9/10" ml-auto w-45 rounded-md>
    </section>
  </div>
</template>
